    ...
    <div class="px-md-4 max-w-6xl mx-auto mb-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                ...
                <div class="card border-0 shadow-lg position-relative overflow-hidden mb-4" style="border-radius: 2.5rem; background: linear-gradient(135deg, #696cff 0%, #3f42ff 100%); color: white;">
                    <!-- Decorative shapes -->
                    <div class="position-absolute top-0 end-0 bg-white opacity-10 rounded-circle" style="width: 250px; height: 250px; margin-top: -100px; margin-right: -100px; filter: blur(50px);"></div>
                    <div class="position-absolute bottom-0 start-0 bg-black opacity-10 rounded-circle" style="width: 150px; height: 150px; margin-bottom: -50px; margin-left: -50px; filter: blur(30px);"></div>

                    <div class="card-body p-5 d-flex flex-column align-items-center text-center position-relative z-1">
                        <div class="p-4 rounded-4 shadow-lg mb-4" style="width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; background-color: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                ...
                <div class="card border-0 shadow-sm rounded-5 overflow-hidden">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="position-relative w-100 rounded-4 overflow-hidden shadow-inner" style="aspect-ratio: 16/9; background: #000;">
                            <iframe 
                ...
                <div class="card border-0 shadow-sm rounded-5 mb-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="d-flex flex-column gap-4">
                            @php
                                $features = [
                                    ['icon' => 'bx-zap', 'title' => 'Lebih Cepat & Stabil', 'desc' => 'Performa maksimal tanpa batasan memori browser Chrome.'],
                                    ['icon' => 'bxl-linkedin', 'title' => 'LinkedIn Scraper', 'desc' => 'Ekstrak data profesional dan perusahaan langsung dari pencarian LinkedIn.'],
                                    ['icon' => 'bx-globe', 'title' => 'Tanpa Batas IP', 'desc' => 'Scraping lebih leluasa karena dijalankan langsung dari local machine.'],
                                    ['icon' => 'bx-shield-quarter', 'title' => 'Anti-Ban Protection', 'desc' => 'Sistem delay dan human-like behavior yang lebih canggih.'],
                                    ['icon' => 'bx-terminal', 'title' => 'Portable Chrome', 'desc' => 'Otomatis mengelola browser session secara mandiri.']
                                ];
                            @endphp

                            @foreach($features as $f)
                            <div class="d-flex gap-4">
                                <div class="bg-light rounded-4 p-3 d-flex align-items-center justify-content-center h-fit shrink-0" style="width: 55px; height: 55px;">

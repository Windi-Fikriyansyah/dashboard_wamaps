              ...
              <div class="app-brand justify-content-center">
                <a href="/" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <div class="p-1 rounded-3 bg-primary shadow-sm d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                      <i class="bx bx-target-lock text-white fs-2"></i>
                    </div>
                  </span>
                  <span class="app-brand-text demo text-body fw-bolder">Wamaps</span>
                </a>
              </div>
              <!-- /Logo -->
